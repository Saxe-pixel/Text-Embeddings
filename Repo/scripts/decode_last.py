#!/usr/bin/env python3
"""Decode escape sequences in selected properties of wikidata_labeled.db."""
import sqlite3
...
def main(db_path: Path = DB_PATH) -> None:
    """Decode UTF-8 escape sequences in the selected properties."""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Decode UTF-8 escape sequences in wikidata_labeled.db")
