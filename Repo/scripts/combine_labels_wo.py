...
def main():
    ...
    for qid, pid, value in src.execute("SELECT qid, pid, value FROM properties"):
        # --- skip unwanted PIDs right away ---
        if pid in UNWANTED_PIDS:
            continue

        # --- look up labels, track missing ---
